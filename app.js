...
const suppliedSeed = [
  ['쟁탈전이 끝난 뒤 [???]를 맡았습니다.','뒤치다꺼리','뒤치닥거리',1],
  ['사냥 중 맡은 [???]을 충실히 수행해 주세요.','역활','역할',2],
  ['[???] 그냥 넘어가도록 하죠.','웬간하면','엔간하면',2],
  ['계단 [???]에서 성직자가 울고 있습니다.','아래쪽','아랫쪽',1],
  ['전사[???] 맡은 임무를 다하겠습니다.','로서','로써',1],
  ['조금만 더 일찍 무기를 강화[???].','할껄','할걸',2],
  ['기사단 임무를 [???] 살펴보았습니다.','곰곰이','곰곰히',1],
  ['던전 안에만 있다 보니 온몸이 [???]하군요.','찌뿌둥','짓부등',1],
  ['[???] 정만큼 기른 정도 큽니다.','낫은','낳은',2],
  ['오렌 국왕 폐하를 진찰할 [???]를 모셔라.','어이','어의',2],
  ['구피의 부탁은 영 [???].','마뜩잖다','마뜩치 않다',1],
  ['불필요한 경쟁을 [???]해야 합니다.','지향','지양',2],
  ['모디아의 [???]은 무엇일까요?','장례 희망','장래 희망',2],
  ['셔스는 한밤중에 [???]를 시도했습니다.','야밤도주','야반도주',2],
  ['[???] 하지 말아요.','헷갈리게','헷깔리게',1],
  ['그들의 [???]은 정말 무섭지요.','새뇌 교육','세뇌 교육',2],
  ['길드원들 모두 싸울 준비가 [???].','됬다','됐다',2],
  ['강력한 [???] 공격이 쇄도했다.','치명타','침형타',1],
  ['[???] 성직자님께 감사의 말씀을 전합니다.','이 자리를 빌어','이 자리를 빌려',2],
  ['아슬론 마을에는 [???] 동안 다녀올 예정인가요?','몇 일','며칠',2],
  ['던전으로 외출하기 전에 문을 [???].','잠궜다','잠갔다',2],
  ['왈츠 재상을 본보기로 [???] 합니다.','삶아야','삼아야',2],
  ['케라수 국왕은 [???] 주무시고 계십니다.','여지껏','여태껏',2],
  ['커넬 주교님은 바쁘니 [???] 이야기합시다.','이따가','있다가',1],
  ['갑자기 발록이 등장해서 [???].','시껍했습니다','식겁했습니다',2],
  ['그 소식은 카베터의 심장에 비수를 [???]','꽂았습니다','꼽았습니다',1],
  ['셀라임 왕자에게 [???] 화를 내고 말았다.','괜히','괞이',1],
  ['모험가 분들의 앞날에 [???].','권투를 빕니다','건투를 빕니다',2],
  ['나겔링 스톤을 보니 마음이 [???].','흐뭇하다','흐믓하다',1],
  ['[???]에는 타고르 마을에 비가 계속 내렸습니다.','지난주','지난 주',1],
  ['성직자가 악마를 [???]했습니다.','때치','퇴치',2],
  ['어떤 직업을 선택[???] 자유입니다.','하든','하던',1],
  ['그들인 깃발전에서 [???] 이겼습니다.','얍삽하게','얍샵하게',1],
  ['타바리 마을 주민들의 사생활을 [???]하지 마십시오.','침해','치매',1],
  ['그 발언은 왕족에 대한 [???]이 될 수도 있습니다.','명예훼손','명예회손',1],
  ['[???] 몬스터를 사냥했습니다.','온종일','왠종일',1],
  ['이아가 [???] 안부를 전해 왔습니다.','간간이','간간히',1],
  ['[???] 용자의 공원에 다녀오십시오.','웬만하면','왠만하면',1],
  ['마법사의 작은 실수가 큰 [???]을 일으켰습니다.','사단','사달',2],
  ['천재 루이는 성격이 [???].','괴팍합니다','괘팍합니다',1],
  ['마법사가 [???]의 위기에 놓였습니다.','절체절명','절대절명',1],
  ['소식을 들은 전사가 [???] 달려왔습니다.','손쌀같이','쏜살같이',2],
  ['[???]에 대해 알고 있는가?','으둠에 전설','어둠의 전설',2],
  ['흑요석 장비를 지금 사용[???]?','해도 되니','해도 돼니',1],
  ['밀레스 쉐폰왕은 온갖 [???]에 시달렸습니다.','음해','음훼',1],
  ['[???] 무한의 탑에 도전해보고 싶군요.','왠지','웬지',1],
  ['[???] 스킬을 연습했습니다.','틈틈히','틈틈이',2],
  ['도적이라면 [???]는 문제없지.','잠을쇄','자물쇠',2],
  ['세계수는 가끔 혼자서 [???]거립니다.','궁시렁','구시렁',2],
  ['소문은 [???] 아벨 마을에 퍼졌습니다.','금세','금새',1],
  ['오늘 [???] 혼돈의 탑에 일찍 왔니?','웬일로','왠일로',1],
  ['마이소시아 정식은 맛이 [???] 좋군.','깨','꽤',2],
  ['무도가에 대한 [???]을 버리게나.','고정관념','고정간염',1],
  ['우리 길드 일에 [???] 마라.','끼여들지','끼어들지',2],
  ['이 퀘스트를 [???] 해결하면 좋을까요?','어떻게','어떡해',1],
  ['포테의 숲을 한참 [???] 길을 찾았습니다.','해메다가','헤매다가',2],
  ['리디아와의 추억을 생각하면 마음이 [???]','저려옵니다','절여옵니다',1],
  ['물의 신전 [???]을 깨끗하게 청소했습니다.','안팎','안밖',1],
  ['랭킹에서 [???] 성적을 거두었습니다.','고무적인','고문적인',1],
  ['이번 승급 시험의 난이도는 [???].','문안하다','무난하다',2],
  ['화론 촌장은 [???]한 태도를 보였습니다.','흐리멍텅','흐리멍덩',2],
  ['피에트 마을에서 [???] 시 2배로 물어내셔야 합니다.','김을 파손','기물 파손',2],
  ['도적의 [???]에 좋은 생각이 떠올랐습니다.','머릿속','머리 속',1],
  ['이나와의 약속은 [???] 지켜야 합니다.','무적권','무조건',2],
  ['바실리스크를 함부로 [???]가는 큰일 납니다.','건들이다','건드리다',2],
  ['지금은 공성전을 할 [???]이 안됩니다.','여권','여건',2],
  ['지속 가능한 성장을 [???]해야 합니다.','지향','지양',1],
  ['[???] 패배한 건지 모르겠습니다.','어쨰서','어째서',2],
  ['길드원을 [???] 확인했습니다.','일일히','일일이',2],
  ['공성전 계획이 [???] 무산되었다.','번번이','번번히',1],
  ['그린혼 학원 식당에 쥐가 [???] 있습니다.','들끌고','들끓고',2],
  ['오피온의 굴 조사를 시작하겠[???].','습니다','읍니다',1],
  ['씰리에게 [???]을 태우던 시절이 엊그제 같군.','무등','목말',2],
  ['백작 부인께 [???] 반말입니까?','얻다 대고','어따 대고',1],
  ['후치가 며칠 전부터 몸살이 [???].','났습니다','낳습니다',1],
  ['포션은 [???] 먹는게 좋습니다.','족음씩','조금씩',2],
  ['[???] 길드 대전도 승리 합시다.','이번주','이번 주',2],
  ['[???]에 적룡굴로 들어갔습니다.','제작년','재작년',2],
  ['곧 그룹 사냥을 시작[???] 합니다.','하려고','할려고',1],
  ['뮤레칸의 등장에 [???]을 찌푸렸습니다.','눈살','눈쌀',1],
  ['모험이 끝난 뒤 모두 함께 [???]를 했습니다','뒷풀이','뒤풀이',2],
  ['계단 [???]에서 성직자가 울고 있습니다','아래쪽','아랫쪽',1],
  ['너는 [???] 아이템을 줍지 않았니?','왜','외',1],
  ['간신 [???]들이 나라를 망치는군요.','모리배','몰이배',1]
